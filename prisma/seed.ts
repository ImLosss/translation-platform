...
const rawGlossaryData = {
  ...
  "REPLACE_AND_LEARN": [
    { "mandarin": "陀舍古帝", "replace": "Api Kaisar Kuno" },
    { "mandarin": "虚无吞炎", "replace": "Api Pelahap Kehampaan" },
    { "mandarin": "净莲妖火", "replace": "Api Iblis Teratai Murni" },
    { "mandarin": "金帝焚天炎", "replace": "Api Kaisar Emas Pembakar Langit" },
    { "mandarin": "生灵之焱", "replace": "Api Roh Hidup" },
    { "mandarin": "八荒破灭焱", "replace": "Api Penghancur Delapan Tanah" },
    { "mandarin": "九幽金祖火", "replace": "Api Naga Emas Kuno" },
    { "mandarin": "红莲业火", "replace": "Api Karma Teratai Merah" },
    { "mandarin": "三千焱炎火", "replace": "Api Tiga Ribu" },
    { "mandarin": "九幽风炎", "replace": "Api Angin Sembilan Kegelapan" },
    { "mandarin": "骨灵冷火", "replace": "Api Tulang Dingin" },
    { "mandarin": "九龙雷罡火", "replace": "Api Petir Sembilan Naga" },
    { "mandarin": "龟灵地火", "replace": "Api Bumi Kura-Kura" },
    { "mandarin": "陨落心炎", "replace": "Api Hati Jatuh" },
    { "mandarin": "海心焰", "replace": "Api Hati Laut" },
    { "mandarin": "火云水焱", "replace": "Api Awan Air" },
    { "mandarin": "火山石焰", "replace": "Api Batu Gunung Vulkanik" },
    { "mandarin": "风雷怒焱", "replace": "Api Naga Amarah Angin" },
    { "mandarin": "青莲地心火", "replace": "Api Inti Teratai Hijau" },
    { "mandarin": "龙凤焱", "replace": "Api Naga Phoenix" },
    { "mandarin": "六道轮回炎", "replace": "Api Enam Sisi Reinkarnasi" },
    { "mandarin": "万兽灵火", "replace": "Api Sepuluh Ribu Makhluk" },
    { "mandarin": "玄黄炎", "replace": "Api Kuning Xuan" },
