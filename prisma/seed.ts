...
const rawGlossaryData = {
    "LIST_CULTIVATION": [
        ...
        { "mandarin": "化神", "replace": "Deity Transformation" },
        { "mandarin": "炼虚", "replace": "Void Refinement" },
        { "mandarin": "合体", "replace": "Body Integration" },
        { "mandarin": "大乘", "replace": "Grand Ascension" },
        { "mandarin": "渡劫", "replace": "Tribulation Transcendence" },
        { "mandarin": "伪仙", "replace": "Pseudo Immortal" },
        { "mandarin": "真仙", "replace": "True Immortal" },
        { "mandarin": "金仙", "replace": "Golden Immortal" },
        { "mandarin": "太乙玉仙", "replace": "Taiyi Jade Immortal" },
        { "mandarin": "大罗", "replace": "Great Encompassment" },
        { "mandarin": "道祖", "replace": "Dao Ancestor" }
    ],
    "REPLACE_AND_LEARN": [
        ...
        { "mandarin": "天南修士", "translate_to": "Kultivator Tiannan", "detail": "istilah" },
        { "mandarin": "黄枫谷", "translate_to": "Lembah Huangfeng", "detail": "istilah" },
        { "mandarin": "雷万鹤", "translate_to": "Lei Wanhe", "detail": "nama karakter" },
        { "mandarin": "韩立", "translate_to": "Han Li", "detail": "nama karakter" },
        ...
        { "mandarin": "九国盟", "translate_to": "Aliansi Sembilan Negara", "detail": "istilah" },
        { "mandarin": "天道盟", "translate_to": "Aliansi Tiandao", "detail": "istilah" },
        { "mandarin": "拘灵之术", "translate_to": "Teknik Pengikat Roh", "detail": "nama teknik/jurus" },
        { "mandarin": "噬金虫", "translate_to": "Serangga Pemakan Logam", "detail": "istilah" },
        { "mandarin": "这御风车", "translate_to": "Kereta Angin", "detail": "istilah" },
        { "mandarin": "灵兽山", "translate_to": "Sekte Lingshou", "detail": "nama sekte" },
        { "mandarin": "落云宗", "translate_to": "Sekte Luoyun", "detail": "nama sekte" },
        { "mandarin": "掩月宗", "translate_to": "Sekte Yanyue", "detail": "nama sekte" },
        { "mandarin": "云梦山", "translate_to": "Sekte Yunmeng", "detail": "nama sekte" },
        { "mandarin": "化刀坞", "translate_to": "Sekte Huadao", "detail": "nama sekte" },
        { "mandarin": "还有巨剑门", "translate_to": "Sekte Jujian", "detail": "nama sekte" },
        { "mandarin": "丰原国", "translate_to": "Negara Fenyuan", "detail": "nama negara" },
        { "mandarin": "隐患", "translate_to": "Bahaya Tersembunyi", "detail": "istilah" },
        { "mandarin": "师祖", "translate_to": "Guru Leluhur", "detail": "istilah" },
        { "mandarin": "师伯", "translate_to": "Paman Guru", "detail": "istilah" },
        ...
        { "mandarin": "天阙堡", "translate_to": "Benteng Tianque", "detail": "organisasi kultivasi/klan besar" },
        ...
        { "mandarin": "金乌炼万灵", "translate_to": "Gagak Emas Pelebur Segala Jiwa", "detail": "istilah" },
        { "mandarin": "尸祖神像", "translate_to": "Patung Dewa Leluhur Mayat", "detail": "istilah" },
        { "mandarin": "太上斩情术", "translate_to": "Teknik Pemutus Perasaan Tertinggi", "detail": "nama teknik" },
        ...
        { "mandarin": "血魔剑", "translate_to": "Pedang Iblis Darah", "detail": "nama benda" },
        { "mandarin": "凝光宝镜", "translate_to": "Cermin Pengumpul Cahaya", "detail": "nama benda" },
        { "mandarin": "轮回神光", "translate_to": "Cahaya Ilahi Samsara", "detail": "nama teknik" },
        ...
        { "mandarin": "魔道", "translate_to": "Aliran Iblis", "detail": "istilah" },
        ...
        { "mandarin": "紫罗极火", "translate_to": "Api Ungu Luo", "detail": "istilah" },
        { "mandarin": "坠魔谷", "translate_to": "Lembah Iblis Jatuh", "detail": "istilah" },
        { "mandarin": "龙尾塞", "translate_to": "Benteng Longwei", "detail": "istilah" },
        { "mandarin": "上师", "translate_to": "Master", "detail": "gelar/panggilan" },
        { "mandarin": "神师", "translate_to": "Master Ilahi", "detail": "gelar/panggilan" },
        { "mandarin": "苍坤上人", "translate_to": "Petapa Cangkun", "detail": "gelar/panggilan" },
        { "mandarin": "陆道友", "translate_to": "Rekan Lu", "detail": "gelar/panggilan" },
